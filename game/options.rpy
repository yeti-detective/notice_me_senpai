...
init -1 python hide:
    ...
    theme.tv(
        ...
        mm_root = "Images/Backgrounds/Title_Bruh.png",
    ...
    style.menu_choice.outlines = [(4, "#060000", 0, 0)]
...
python early:
    config.save_directory = "Test2+-1448137155"
...
init python:
    ...
    build.directory_name = "Test2+-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Test2+"
